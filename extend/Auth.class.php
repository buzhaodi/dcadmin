...
-- ----------------------------
 DROP TABLE IF EXISTS `zwl_auth_rule`;
CREATE TABLE `zwl_auth_rule` (
...
-- ----------------------------
 DROP TABLE IF EXISTS `zwl_auth_group`;
CREATE TABLE `zwl_auth_group` (
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, 
...
-- ----------------------------
DROP TABLE IF EXISTS `zwl_auth_group_access`;
CREATE TABLE `zwl_auth_group_access` (
